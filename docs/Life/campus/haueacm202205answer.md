...
主要的修复内容：
1.  **统一术语**：将“皮搋子”改为更通用的“卡片”，将“扩音器”改为“答案”。
2.  **修正格式**：将“思想2”的列表格式调整正确，并将标题“代码2”修正为“C++ 代码”。
3.  **清理代码**：去除了第一段代码末尾多余的 ``` 符号，并规范了代码的缩进。
...
**修复说明**：
- 修正了代码块的语言标记（原文误标为 `java`，实际为 C++ 代码）。
- 保持文本内容、格式、数学符号及代码逻辑不变。
- 输入/输出样例的代码块语言标记同步修正。
