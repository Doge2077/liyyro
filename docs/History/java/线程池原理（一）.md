...
![image-20240625142529340](https://cdn.jsdelivr.net/gh/Doge2077/liyyro-photo@main/images/2024/06/image-20240625142529340.png)
...
![image-20240625144239291](https://cdn.jsdelivr.net/gh/Doge2077/liyyro-photo@main/images/2024/06/image-20240625144239291.png)
...
核心线程数
  ...
  * 线程池刚创建时，线程数量为0，当每次执行 execute 添加新的任务时会在线程池创建一个新的线 程，直到线程数量达到 corePoolSize 为止。
  * 核心线程会一直存活，即使没有任务需要执行，当线程数小于核心线程数时，即使有线程空闲，线程 池也会优先创建新线程处理
...
一个线程同时只能执行一个任务，但可以同时向一个线程池提交多个任务。![image-20240625164308135](https://cdn.jsdelivr.net/gh/Doge2077/liyyro-photo@main/images/2024/06/image-20240625164308135.png)
...
![image-20240625174625992](https://cdn.jsdelivr.net/gh/Doge2077/liyyro-photo@main/images/2024/06/image-20240625174625992.png)
