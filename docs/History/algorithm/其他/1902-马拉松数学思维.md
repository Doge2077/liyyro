...
在那里，她有望在一场马拉松比赛中穿越约翰农场所在的城市的市中心。
...
int main() {
    int n;
    struct point a[1000];
    long long road = 1000000000000000000LL;
    long long past = 0, now = 0, sum = 0;
