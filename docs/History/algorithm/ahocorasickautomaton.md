...
[Original Link](&lt;https://www.acwing.com/problem/content/145/&gt;)
...
**本质上** ：
  ...
  * 用 `Trie` 存单词，由 `26` 个小写字母构造的 `Trie`，是一颗`26` 叉树，深度为最长单词的长度。
  * 用 `Trie` 存整数，由整数的十进制位构造的 `Trie`，是一颗 `10` 叉树，深度为 `10` 层。
...
[Original Link](&lt;https://www.acwing.com/problem/content/1284/&gt;)
...
[Original Link](&lt;https://www.acwing.com/problem/content/1287/&gt;)
