...
**题目大意** ：
  ...
  * 求是否存在长度为 $17$ 的子序列满足： 
    ...
    * [latex]S′_6 , S′_7 , . . . , S′_{11}, S′_{12}[/latex] 为同一个字符；
    * [latex]S′_{13}, S′_{14}, S′_{15}, S′_{16}, S′_{17}[/latex] 为同一个字符。
...
**思想** ：
  ...
  * 暴力枚举 $S_j$，统计满足的 [latex]S'_6 \sim S'_{12}[/latex]，若可以找到满足的子序列，标记该字符后进入下一层循环；
  * 暴力枚举 [latex]S_k[/latex]，统计满足的 [latex]S'_{13} \sim S'_{17}[/latex]，若可以找到满足的子序列，则将上面标记的直接输出即可。
