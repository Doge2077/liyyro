...
([SI](</wiki/%E5%9B%BD%E9%99%85%E5%8D%95%E4%BD%8D%E5%88%B6> "国际单位制")) | [二进制前缀](</wiki/%E4%BA%8C%E9%80%B2%E4%BD%8D%E5%89%8D%E7%BD%AE%E8%A9%9E> "二进制前置词")  
([IEC 60027-2](</wiki/IEC_60027-2> "IEC 60027-2"))  
---|---  
名字 | 缩写 | 次方 | 名字 | 缩写 | 次方  
[kilobit](</wiki/%E5%8D%83%E6%AF%94%E7%89%B9> "千比特") | kbit | [103](</wiki/1000> "1000") | [kibibit](</wiki/Kibibit> "Kibibit") | Kibit | [210](</wiki/1024> "1024")  
[megabit](</wiki/Megabit> "Megabit") | Mbit | [106](</wiki/1_E6> "1 E6") | [mebibit](</wiki/Mebibit> "Mebibit") | Mibit | [220](</wiki/1048576> "1048576")  
[gigabit](</wiki/Gigabit> "Gigabit") | Gbit | [109](</wiki/1_E9> "1 E9") | [gibibit](</wiki/Gibibit> "Gibibit") | Gibit | [230](</wiki/1073741824> "1073741824")  
[terabit](</wiki/Terabit> "Terabit") | Tbit | [1012](</wiki/1_E12> "1 E12") | [tebibit](</wiki/Tebibit> "Tebibit") | Tibit | [240](</wiki/1099511627776> "1099511627776")  
[petabit](</wiki/Petabit> "Petabit") | Pbit | [1015](</wiki/1_E15> "1 E15") | [pebibit](</wiki/Pebibit> "Pebibit") | Pibit | [250](</wiki/1125899906842624> "1125899906842624")  
[exabit](</wiki/Exabit> "Exabit") | Ebit | [1018](</wiki/1_E18> "1 E18") | [exbibit](</wiki/Exbibit> "Exbibit") | Eibit | [260](</wiki/1152921504606846976> "1152921504606846976")  
[zettabit](</wiki/Zettabit> "Zettabit") | Zbit | [1021](</wiki/1_E21> "1 E21") | [zebibit](</wiki/Zebibit> "Zebibit") | Zibit | [270](</wiki/1180591620717411303424> "1180591620717411303424")  
[yottabit](</wiki/Yottabit> "Yottabit") | Ybit | [1024](</wiki/1_E24> "1 E24") | [yobibit](</wiki/Yobibit> "Yobibit") | Yibit | [280](</wiki/1208925819614629174706176> "1208925819614629174706176")  
...
---|---  
名字 | 缩写 | 次方 | 名字 | 缩写 | 次方  
[千字节](</wiki/%E5%8D%83%E5%AD%97%E8%8A%82> "千字节") | KB | [103](</wiki/1_E3> "1 E3") | [kibibyte](</wiki/Kibibyte> "Kibibyte") | KiB | 210  
[兆字节](</wiki/%E7%99%BE%E8%90%AC%E4%BD%8D%E5%85%83%E7%B5%84> "兆字节") | MB | [106](</wiki/1_E6> "1 E6") | [mebibyte](</wiki/Mebibyte> "Mebibyte") | MiB | 220  
[吉字节](</wiki/%E5%90%89%E5%AD%97%E8%8A%82> "吉字节") | GB | [109](</wiki/1_E9> "1 E9") | [gibibyte](</wiki/Gibibyte> "Gibibyte") | GiB | 230  
[太字节](</wiki/%E5%A4%AA%E5%AD%97%E8%8A%82> "太字节") | TB | [1012](</wiki/1_E12> "1 E12") | [tebibyte](</wiki/Tebibyte> "Tebibyte") | TiB | 240  
[拍字节](</wiki/%E6%8B%8D%E5%AD%97%E8%8A%82> "拍字节") | PB | [1015](</wiki/1_E15> "1 E15") | [pebibyte](</wiki/Pebibyte> "Pebibyte") | PiB | 250  
[艾字节](</wiki/%E8%89%BE%E5%AD%97%E8%8A%82> "艾字节") | EB | [1018](</wiki/1_E18> "1 E18") | [exbibyte](</wiki/Exbibyte> "Exbibyte") | EiB | 260  
[泽字节](</wiki/%E6%B3%BD%E5%AD%97%E8%8A%82> "泽字节") | ZB | [1021](</wiki/1_E21> "1 E21") | [zebibyte](</wiki/Zebibyte> "Zebibyte") | ZiB | 270  
尧字节 | YB | [1024](</wiki/1_E24> "1 E24") | [yobibyte](</wiki/Yobibyte> "Yobibyte") | YiB | 280  
容字节 | RB | [1027](</wiki/1_E27> "1 E27") |  |  |   
昆字节 | QB | [1030](</wiki/1_E30> "1 E30") |  |  |   
...
---|---  
名称 | 符号 | 次方 | 名称 | 符号 | 次方  
[千比特每秒（kbps）](</wiki/Kilobit_per_second> "Kilobit per second") | kbit/s | [103](</wiki/1000> "1000") | [二进制千比特每秒（Kibps）](</w/index.php?title=Kibibit_per_second&action=edit&redlink=1> "Kibibit per second（页面不存在）") | Kibit/s | 210  
[兆比特每秒（Mbps）](</w/index.php?title=Megabit_per_second&action=edit&redlink=1> "Megabit per second（页面不存在）") | Mbit/s | [106](</wiki/1_E6> "1 E6") | [二进制兆比特每秒（Mibps）](</w/index.php?title=Mebibit_per_second&action=edit&redlink=1> "Mebibit per second（页面不存在）") | Mibit/s | 220  
[吉比特每秒（Gbps）](</w/index.php?title=Gigabit_per_second&action=edit&redlink=1> "Gigabit per second（页面不存在）") | Gbit/s | [109](</wiki/1_E9> "1 E9") | [二进制吉比特每秒（Gibps）](</w/index.php?title=Gibibit_per_second&action=edit&redlink=1> "Gibibit per second（页面不存在）") | Gibit/s | 230  
[太比特每秒（Tbps）](</w/index.php?title=Terabit_per_second&action=edit&redlink=1> "Terabit per second（页面不存在）") | Tbit/s | [1012](</wiki/1_E12> "1 E12") | [二进制太比特每秒（Tibps）](</w/index.php?title=Tebibit_per_second&action=edit&redlink=1> "Tebibit per second（页面不存在）") | Tibit/s | 240  
...
---
  ...
  * **应用层** （ _Application Layer_ ）：应用层处于最上层，也是我们能直接接触到的。
...
物理层可以使用两种主要的传输方式：模拟传输和数字传输：
  ...
  * 模拟传输：将比特流被编码为**连续的模拟信号** 进行传输，例如电压或电流的变化。
...
* 连续性：模拟传输使用连续的信号表示数据。
```java
* 带宽：模拟传输的带宽受限于媒介的频率响应。
```java
* 噪声敏感性：模拟传输对噪声和干扰较为敏感，可能导致数据损坏或失真。
```
  ...
  * 数字传输：将比特流被编码为**离散的数字信号** 进行传输，例如高电平和低电平。
...
* 离散性：数字传输使用离散的信号表示数据。
```java
* 可靠性：数字传输通过使用错误检测和纠正技术来提高数据的可靠性。
```java
* 抗干扰性：数字传输对于噪声和干扰具有较强的抗干扰能力。
```
...
耐斯特定理（Nyquist theorem）：

  * 描述了在没有噪声干扰的理想条件下，最高可达的数据传输速率。
  * 根据耐斯特定理，对于带宽为 $B$ 的信道，最大可达的比特率为 $2B$ 比特每秒。
...
**注** ：
  ...
  * **带宽** ：（ _Bandwidth_ ）指信号所占据的[频带](&lt;https://zh.wikipedia.org/wiki/频带&gt;)宽度；在被用来描述[信道](&lt;https://zh.wikipedia.org/wiki/信道&gt;)时，带宽是指能够有效通过该信道的信号的最大频带宽度。
...
香农公式说明:
  ...
  * 记信号功率最大为 $E_{s}$，则带宽无穷大时，信道容量的极限为
  * $\lim _&#123;&#123;B\rightarrow \infty &#125;&#125;B\log_{2}\left(1+{\frac {E _{s&#125;&#125;{BN_{0&#125;&#125;}\right)\approx 1.44{\frac {E _{s&#125;&#125;{N_{0&#125;&#125;}$
...
* 解决了 NRZ 的一些问题，通过1的跳变来表示位的改变，但仍然存在直流分量累加的问题。
```
  * 曼彻斯特编码： 
```java
* 每个时钟周期被分为两个相等的时间段:
* 如果要传输的二进制位是0，则在第一个时间段中信号电平发生变化；
* 如果要传输的二进制位是1，则在第二个时间段中信号电平发生变化。
...
信道复用技术：将多个独立的信号或数据流同时传输在同一物理传输介质上的技术
  ...
  * 频分多路复用（FDM）： 
```java
* 将不同的信号被分配到不同的频率带宽上，这样它们可以同时传输而不会互相干扰
* 每个信号占据一定的频率范围，这些频率范围之间有一定的间隔，以确保信号之间的隔离
```
  * 时分多路复用（TDM）： 
```java
* 将时间被划分为若干个时隙，每个时隙用于传输不同的信号
* 每个信号在各自的时隙中按照固定的时间间隔传输，这样多个信号可以在同一传输介质上交替传输，实现同时传输的效果
```
  * 波分多路复用（WDM）： 
```java
* 利用不同的光波长将多个信号同时传输在同一光纤上
* 在WDM中，每个信号被调制到不同的光波长上，这些光波长之间有一定的间隔，以确保信号之间的隔离
* 光波长的数量决定了WDM系统的容量，可以实现高带宽的传输
```
  * 码分多路复用（CDM）： 
```java
