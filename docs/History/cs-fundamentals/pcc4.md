...
例如，设CPU地址线为 $16$ 位 $A_{15} \sim A_0 $：
  ...
  * 用 [latex]16K \times 1[/latex] 位存储芯片时，有 [latex]14[/latex] 根地址线 [latex]A_{13} \sim A_0[/latex]，此时，可将CPU的低位地址 [latex]A_{13} \sim A_0[/latex] 与存储芯片地址线 [latex]A_{13} \sim A_0[/latex] 相连。
...
![](https://cdn.jsdelivr.net/gh/Doge2077/liyyro-photo@main/images/2023/03/Cache读操作.png)
...
![](https://cdn.jsdelivr.net/gh/Doge2077/liyyro-photo@main/images/2023/03/Cache直接映射.png)
...
![](https://cdn.jsdelivr.net/gh/Doge2077/liyyro-photo@main/images/2023/03/Cache全相联映射.png)
