...
~~你急了，你急了，你急了，因为你很迷~~ ，你不明白 `stdin`、`scanf`、`cin`、`std::cin`、`getline`、`stringstream` 还有 `stdout`、`printf`、`cout`、`std::cout` 这些都是什么~~寄吧~~ 玩意，对吧？再来明确一下：
  ...
  * 至于 `stringstream` 这个~~逼~~ 东西，我们放到最后细嗦。
